...
There has been much previous work in the are of visualising relationships between people in virtual environments such as social networks. However this has almost exclusively focused on static systems of relationships.

{\bf Aims}
What has been learned from the visualisation of static will be applied to the representation of dynamic systems with a focus on the interactions between the users rather than simple the static relationships.
...
{\bf Results}
The system is able to effectively represent several different real-world scenarios representing a wide variety of situations. Further it is can be seen that this system of looking at interactions is more effective than currently available approaches.
